...
| `treehouse-loop/` | Rooms she builds on treehouse hardpoints, decorations placed freely inside them with no snapping, a drawer pre-filtered to decorations, the MORE door to the Decorator Machine, and the way back — with no dead ends and one shared inventory |
